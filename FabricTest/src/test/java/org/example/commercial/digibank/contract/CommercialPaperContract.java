...
import org.example.commercial.digibank.contract.ledgerapi.State;
...
/**
 * @author fabric
 * @apiNote A custom context provides easy access to list of all commercial papers
 * @implNote Define commercial paper smart contract by extending Fabric Contract class
 * @since 2022/9/29 15:21
 */
@Contract(name = "org.papernet.commercialpaper",
        info = @Info(title = "MyAsset contract", description = "", version = "0.0.1",
                ...
                contact = @Contact(email = "java-contract@example.com",
                        name = "java-contract", url = "http://java-contract.me")
        )
)
@Default
