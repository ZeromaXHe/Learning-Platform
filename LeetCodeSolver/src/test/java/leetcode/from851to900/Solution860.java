 ...
 * @Description: 860.柠檬水找零 | 难度：简单 | 标签：贪心算法
...
public class Solution860 {
    /**
     * 执行用时： 3 ms , 在所有 Java 提交中击败了 22.88% 的用户
     * 内存消耗： 39.2 MB , 在所有 Java 提交中击败了 93.21% 的用户
     *
     * @param bills
     * @return
     */
    public boolean lemonadeChange(int[] bills) {
        ...
        for (int i = 0; i < bills.length; i++) {
            ...
            // System.out.println("i:" + i + " bills[i]:" + bills[i] + " count:" + Arrays.toString(count));
        }
        return true;
    }
