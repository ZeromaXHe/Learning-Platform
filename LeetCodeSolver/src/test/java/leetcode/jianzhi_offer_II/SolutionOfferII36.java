...
/**
 * @author zhuxi
 * @apiNote 剑指 Offer II 036. 后缀表达式 | 难度：中等 | 标签：栈、数组、数学
 ...
 * @implNote
 * @since 2023/6/21 17:18
 */
public class SolutionOfferII36 {
    /**
     * 执行用时：4 ms, 在所有 Java 提交中击败了 94.70% 的用户
     * 内存消耗：41.7 MB, 在所有 Java 提交中击败了 44.25% 的用户
     * 通过测试用例：20 / 20
     *
     * @param tokens
     * @return
