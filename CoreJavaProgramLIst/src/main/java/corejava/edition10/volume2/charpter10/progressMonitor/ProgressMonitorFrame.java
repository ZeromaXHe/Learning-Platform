package corejava.edition10.volume2.charpter10.progressMonitor;
 ...
 * @Description: A frame that contains a button to launch a simulated activity and a text area for the activity output.
 * @Modified By: zhuxi
 */
