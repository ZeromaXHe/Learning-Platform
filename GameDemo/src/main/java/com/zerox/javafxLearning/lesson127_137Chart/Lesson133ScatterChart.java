...
/**
 * @Author: zhuxi
 * @Time: 2022/5/20 16:50
 * @Description:
 * @ModifiedBy: zhuxi
 */
public class Lesson133ScatterChart extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ScatterChart<Number, Number> scatterChart = getBubbleChart();

        Button bu = new Button("button");
        HBox hBox = new HBox(20);
        hBox.getChildren().addAll(bu, scatterChart);
        ...
        URL url = this.getClass().getClassLoader().getResource("css/Lesson133ScatterChart.css");
    ...
    private ScatterChart<Number, Number> getBubbleChart() {
